  ...
  return (
    <section className="relative h-[70vh] md:h-[100vh] w-full overflow-hidden bg-black flex items-center">
      <div className="absolute inset-0 z-0">
        <Image
          src="/jazz.webp" 
          alt="Live jazz ensemble performing at a corporate event in Dublin, Ireland"
          fill
      ...
      <div className="container relative z-30 mx-auto px-8 md:px-16 lg:px-24">
        <div className="flex flex-col items-start text-left max-w-4xl">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="pl-2 mb-10">
          ...
          <div className="pl-1">
            <p className="text-[10px] md:text-[11px] tracking-[0.6em] uppercase text-[#C5A059] font-medium leading-relaxed">
              THE SOPHISTICATED ENERGY <br />
              <span className="text-white/60">OF THE GOLDEN AGE</span>
            </p>
          </div>
        </div>
      </div>
