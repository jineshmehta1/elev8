...
export function DJLiveHero() {
  return (
    <section className="relative h-[70vh] md:h-[80vh] w-full overflow-hidden bg-black flex items-center">
      <div className="absolute inset-0 z-0">
        <Image
          src="/dj-live-banner.webp" 
          alt="DJ and live musician performing at a high-energy event in Dublin"
          fill
        ...
        <div className="flex flex-col items-start text-left max-w-4xl">
          ...
          <div className="pl-1">
            <p className="text-[10px] md:text-[11px] tracking-[0.6em] uppercase text-[#C5A059] font-medium leading-relaxed">
              THE ULTIMATE FUSION <br />
              <span className="text-white/60">OF CURATION AND PERFORMANCE</span>
            </p>
          </div>
        </div>
      </div>
